...
function filter( array, term ) {
	...
	var normalizedMatcher = new RegExp( '(^|)('+$.ui.autocomplete.escapeRegex(normalize(term))+')(|$)', "ig" );
	return $.grep( array, function(value) {
		if ((matcher.test( $( "<div>" ).html( (value.search || value.label || value.value || value) ).text() ))||
		(normalizedMatcher.test( $( "<div>" ).html( normalize(value.search || value.label || value.value || value) ).text() ))) {
